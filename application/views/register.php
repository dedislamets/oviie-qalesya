            ...
            <form method="POST" action="<?php echo base_url() ?>index.php/register/daftar">
              <div class="card card-login">
                ...
                <div class="card-body ">
                  ...
                  <div class="input-group">
                    <div style="display: block;width: 100%;">Kelurahan</div>
                    <div class="input-group-prepend">
                      <span class="input-group-text">
                      </span>
                    </div>
                ...
                <p class="font-weight-bold text-uppercase text-center mb-2">Lupa Member ID? <a href="<?= base_url()?>">Klik Disini</a></p>
