        ...
        <div class="container">
          <div class="col-lg-6 col-md-8 ml-auto mr-auto">
            ...
            <div class="card card-login hidden" style="padding-top: 10px;" id="panel-info">
              <h4 class="header text-center">Member ID anda adalah :</h4>
              <h3 class="header text-center"><span id="kode_member"></span> - <span id="nama_member"></span></h3>
              <p class="font-weight-bold text-uppercase text-center mb-2"><a href="<?= base_url()?>lupa">Kembali</a></p>
            </div>
              ...
              <div class="card card-login">
                <div class="card-header ">
                  <div class="card-header ">
                    ...
                    <h3 class="header text-center" style="margin-bottom: 10px">LUPA MEMBER ID</h3>
                    <p style="text-align: center;">Silahkan masukkan no HP/WA anda</p>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#submit').on('click', function (event) {
          ...
          $.get('<?= base_url()?>lupa/cek', {no: $("#nomor_wa").val()}, function(data){ 
            if(data === null){
              ...
              $("#kode_member").text(data.kode_member);
              $("#nama_member").text(data.nama_lengkap);
            }
          })
      });
