...
<body class="login-page">
  ...
  <div class="wrapper wrapper-full-page ">
    <div class="full-page section-image" filter-color="black" data-image="<?= base_url(); ?>assets/images/rm288-ka-18.jpg">
            ...
            <form method="POST" action="<?php echo base_url() ?>index.php/login">
              <div class="card card-login">
                <div class="card-header ">
                  <div class="card-header ">
                    <h3 class="header text-center">Oviie Qalesya Shop & Boutique</h3>
                  </div>
                </div>
                <div class="card-body ">
