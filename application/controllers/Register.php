...
class Register extends CI_Controller {
    ...
    {       
        ...
        if(!empty($cek_duplicate)){
            $this->session->set_flashdata('message', 'Selamat anda sudah terdaftar di Oviie Qalesya Boutique <br><br>
        <div style="color: darkblue;font-weight: bold;text-align:center">MEMBER :<br>' . $cek_duplicate['kode_member'] . '</div><br>
