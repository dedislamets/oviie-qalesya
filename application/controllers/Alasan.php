...
class Alasan extends CI_Controller {
		...
		if($this->admin->logged_id())
    {
			...
			$data['title'] = 'Alasan Blacklist';
			$data['main'] = 'alasan/index';
			$data['js'] = 'script/alasan';
			$data['modal'] = 'modal/alasan';
  ...
  public function edit(){
      ...
      $arr_par = array('id' => $id);
      $data['parent'] = $this->admin->getmaster('tb_alasan',$arr_par);
  ...
  {       
      ...
      if($this->input->post('id') != "") {
          ...
          $result  =  $this->db->update('tb_alasan');  
          ...
          $result  = $this->db->insert('tb_alasan', $data);
  ...
  public function delete()
  {
    $response = [];
    $response['error'] = TRUE; 
    if($this->admin->deleteTable("id",$this->input->get('id',TRUE), 'tb_alasan' )){
      $response['error'] = FALSE;
    } 
